...
if [[ $USER == 'root' ]]; then
  _zen() {
    ...
    db_file="/opt/MediaEase/MediaEase/frontend/var/data.db"
    ...
    mapfile -t software_apps < <(find /opt/MediaEase/MediaEase/scripts/src/software/{official,experimental} -maxdepth 1 -mindepth 1 -type d -exec basename {} \;)
